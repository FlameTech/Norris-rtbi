...
/**
 * Description this class rappresent a MapChart Object and its methods
 * @class MapChart
 * @param {String} title
 * @param {Array} paths
 * @param {Array} points
...
function MapChart(title, paths, points, centerLatitude, centerLongitude, options) {
  ...
  /**
   * Description this function return this MapChart's ID
   * @method getChartInfo
  ...
  /**
   * Description this function update a MapChart with a new position
