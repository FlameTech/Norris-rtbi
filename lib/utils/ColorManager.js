...
/**
 * Description: this function creates an array of different colors
...
/**
 * Description: checks the consistency of an hexadecimal color and returns an object with an RGB representation of the hex color; returns empty object otherwise
