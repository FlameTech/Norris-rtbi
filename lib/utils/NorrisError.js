...
var errorCode = { 1100: ["General Error", "Check EVERYTHING!"]
                ...
                , 5009: ["Map Data Error", "Path route calculation mode invalid"]
                ...
                , 7000: ["Active Resource Data Error", "Active Resource Graph not found"]
                , 7001: ["Active Resource Page Error", "Active Resource Page not found"]
                };


/**
 * Description: this function create a NorrisError
 * @method NorrisError
 * @param {Number} err
 * @return void
 */
...
/**
 * Description: this function create the NorrisError string 
 * @method toString
 * @return String 
 */
