...
/**
 * Description: this function fill tableOptions with default options
...
/**
 * Description: this function fill tableOptions with the dev's options
 * @method fillDevOpts
 * @param { JSON } options
 * @param { JSON } tableOptions
...
var fillDevOpts = function(options, tableOptions, columns) {
  if(options.insertPosition != undefined)
    ...
    tableOptions.insertPosition = "top";
...
/**
 * Description: this function fill tableOptions with default color options
...
/**
 * Description: this function fill tableOptions with the dev's cellBackGround color options
...
/**
 * Description: this function fill tableOptions with the dev's font color options
...
exports.updateInPlace = function(graphID, row, column, newValue, options) {
  ...
  if(row > -1 && row < _tableModel._data.length) {
    if(column > -1 && column < _tableModel._data[row].length) {
      ...
      else if(!dataConsistency.inPlaceTableOptionsConsistency(options, optTempl))
...
/**
 * Description: this function insert the new data in the model
...
/**
 * Description: this function construct the colors array for the client
...
/**
 * Description: this function remove a row in the model
 * @method removeRow
 * @param { Table } _tableModel
 * @return void
 */
...
exports.updateStream = function (graphID, data, options) {
  ...
  if(!data instanceof Array)
    ...
    if(data.length > _tableModel._headers.length) {
      for(var i = _tableModel._headers.length; i < data.length-1; i++)
        data.pop();
    }
    var fontColor = [];
    var cellColor = [];
