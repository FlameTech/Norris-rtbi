...
/**
 * Description: this method checks if the grid, legend or border property has the correct form
...
/**
 * Description: this method check if the value corresponds to the accepted ones
 * @method pathMode
 * @param { String } obj
 * @return void
 */
...
/**
 * Description: this method checks if the insert position property for Table has the correct form
...
/**
 * Description: this method checks if the displayed lines property for Table has the correct value
...
/**
 * Description: this method contains the other methods that check the color options
...
/**
 * Description: this method checks if the charts options parameter have the correct form
...
/**
 * Description: this method check option parameter for inPlace update for Table
...
/**
 * Description:  this method check option parameter for stream update for Table
...
exports.streamTableOptionsConsistency = function(obj, template) {
  for(var opt in obj) {
    ...
    if(opt == "colorRow" || opt == "colorRowFont") {
      ...
      if(nestedOpt instanceof Array) {
        for(var i=0; i<nestedOpt.length; i++) {
          if(!(typeof nestedOpt[i][0] == "number") || !(typeof nestedOpt[i][1] == "string")) {
            if(opt == "colorFont") {
          ...
          //checks if the string starts with the '#' character and assigns the correct regex
            ...
            //executes the regex
            var result = regex.exec(nestedOpt[i][1]);
            if(!result) {
              console.log("Warning: Options color must be an hex string. \n Color not applied.");
              return false;
            }
...
/**
 * Description: this method check if labels are consistent
...
/**
 * Description: this method check if labels length are consistent with series length
