 ...
 * Location : /norris/lib/test/barChartController
 * 
 * History :
...
describe('TU1 - barChartController.getChartInfo()', function() {
  
  it('Should execute correctly when return the correct chart', function() {
    var check = true;
    try{
     barChartController.getChartInfo(2); 
    } catch(err) {
      if(err === 7000)
        check = false;
    }
